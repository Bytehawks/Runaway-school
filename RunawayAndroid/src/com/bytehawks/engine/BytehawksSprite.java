 ...
 * 
 */
public class BytehawksSprite extends BytehawksAbstractSprite
{
	 ...
	 */
	public BytehawksSprite(BytehawksSpriteLayout layout)
	{
		super(layout);
		doInit(0, 0, 1);
	}
	 ...
	 * @param layout BytehawksSpriteLayout
	 */
	public BytehawksSprite(int x, int y, BytehawksSpriteLayout layout)
	{
		super(layout);
		doInit(x, y, 1);
	}
	 ...
	 * @param layout BytehawksSpriteLayout
	 */
	public BytehawksSprite(int x, int y, float alpha, BytehawksSpriteLayout layout)
	{
		super(layout);
		doInit(x, y, alpha);
	}
		...
		if (roLayout != null)
		{
			if (roLayout.roTexture != null)
			{
				if (roLayout.roTexture.mHWTextureID > -1)
				{
					...
					((GL11Ext) gl).glDrawTexfOES(mPosition.mX - (roLayout.getPivot(roFrame).mX * mScale.mX), BytehawksSurfaceView.roHeight
