 ...
 * 
 */
public class BytehawksSegmentCollider
{
	protected BytehawksPhysicObject mObject;
	protected BytehawksVector mA;
	protected BytehawksVector mB;
	protected BytehawksVector mDir;
	protected BytehawksVector mDiff;
	protected BytehawksVector mClosest;
	protected float mNormal;
	private float mLength;

	public BytehawksSegmentCollider(float x1, float y1, float x2, float y2)
	{
		mA = new BytehawksVector(x1, y1);
		mB = new BytehawksVector(x2, y2);
		mDir = new BytehawksVector();
		calculate();
	}
	...
	public float closestDist(BytehawksCircleCollider other)
	{
		return Math
