 ...
 *
 */
public class BytehawksSurfaceView extends SurfaceView implements SurfaceHolder.Callback
{
	...
	private BytehawksActivity mActivity; //For future use
	...
	public BytehawksSurfaceView(Context context)
	{
		super(context);
		init(context);
	}

	public BytehawksSurfaceView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init(context);
	}
	...
	{
		if (context instanceof BytehawksActivity)
			mActivity=(BytehawksActivity)context;
		...
		mTextureEngine=new BytehawksTextureEngine();
	...
	public BytehawksTextureEngine getTextureEngine()
	{
