 ...
 * 
 */
public class BytehawksFont
{
	private static final short DEFAULT_FONT_CHARS = 93;
	protected BytehawksTexture mTexture;
	 ...
	 */
	public BytehawksFont(BytehawksSurfaceView view, float fontSize, Typeface typeface, int space, int red, int green, int blue, int alpha)
	{
	 ...
	 * @param alpha		Color of the font (Alpha channel)
	 */
	public BytehawksFont(BytehawksSurfaceView view, float fontSize, Typeface typeface, int charCount, int border, int space, int red, int green,
			int blue, int alpha)
	{
		mTextureEngine=view.getTextureEngine();
	 ...
	 * @param alpha		Color of the font (Alpha channel)
	 */
	public BytehawksFont(BytehawksSurfaceView view, float fontSize, Typeface typeface, char[] chars, int border, int space, int red, int green,
			int blue, int alpha)
	{
		mTextureEngine=view.getTextureEngine();
	 ...
	 * @param space		Space between characters
	 */
	public BytehawksFont(BytehawksSurfaceView view, String asset, int resourceId, int space)
	{
		mTextureEngine=view.getTextureEngine();
		loadFrom(asset);
	...
	private void loadFrom(String asset)
	{
		...
		try
		{
			is = BytehawksSurfaceView.mContext.getAssets().open(asset);
		...
		finally
		{
			...
			{
				Log.e("BytehawksFont", "loadFrom::InputStream.close error: " + e.getMessage());
			}
		}
	}
