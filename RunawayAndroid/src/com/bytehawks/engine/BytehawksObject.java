 ...
 *
 */
public class BytehawksObject
{
	AtomicBoolean updating;
	public Object mParent;
	protected BytehawksObject[]mChilds;
	protected BytehawksObject[]mNewChilds;
	...
	public BytehawksObject ()
	{
		mMaxObjects=BytehawksSurfaceView.sMaxObjects;
		doInit();
	}

	/**
	 * Create BytehawksObject specifying the maximum direct descendants
	 * @param maxObjects
	 */
	public BytehawksObject (int maxObjects)
	{
	...
	{
		mDie=false;
		mChilds=new BytehawksObject[mMaxObjects];
		mNewChilds=new BytehawksObject[mMaxObjects];
		mChildsCount=0;
		mNewChildsCount=0;
	 ...
	 */
	public BytehawksObject addObject(BytehawksObject object)
	{
		object.mDie=false;
		while (updating.get());
		for (int t=0;t<mChildsCount;t++)
	 ...
	 */
	public void removeObject(BytehawksObject object)
	{
		if (object!=null)
			object.mDie=true;
	}
	...
	/**
	 * 
	 * @return Main BytehawksSurfaceView
	 */
	public BytehawksSurfaceView getSurfaceView()
	{
		if (mParent instanceof BytehawksSurfaceView)
			return (BytehawksSurfaceView) mParent;
		else
			return ((BytehawksObject) mParent).getSurfaceView();
	}
	 ...
	 */
	public BytehawksObject getParent ()
	{
		if (mParent instanceof BytehawksObject)
			return (BytehawksObject) mParent;
		return null;
	}
	 ...
	 */
	public BytehawksObject childAt(int idx)
	{
