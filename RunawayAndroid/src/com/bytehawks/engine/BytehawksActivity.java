 ...
 * 
 */
public class BytehawksActivity extends Activity
{
	public BytehawksSurfaceView mGLSurfaceView; // The main GL View
	public XmlPullParser xmlParser;
	protected BytehawksUI mCurrentUI = null;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		{
			Thread.sleep(100);
			mGLSurfaceView = new BytehawksSurfaceView(this);
	 ...
	 * @param currentUI
	 */
	public void setUI(BytehawksUI currentUI)
	{
