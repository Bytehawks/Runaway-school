 ...
 * 
 */
public abstract class BytehawksTexture
{
	...
	public BytehawksTexture(BytehawksTextureEngine textureEngine)
	{
	...
	public void load(GL10 gl)
	{
		if ((gl!=null)&&(mHWTextureID>-1))
		{
			...
			if (error != GL10.GL_NO_ERROR)
				Log.e("BytehawksTexture", "load Bind GLError: " + error);
			...
			error = gl.glGetError();
			if (error != GL10.GL_NO_ERROR)
				Log.e("BytehawksTexture", "load Parameterf GLError: " + error);
	
			gl.glTexEnvf(GL10.GL_TEXTURE_ENV, GL10.GL_TEXTURE_ENV_MODE, GL10.GL_MODULATE);
			
			error = gl.glGetError();
			if (error != GL10.GL_NO_ERROR)
				Log.e("BytehawksTexture", "load Envf GLError: " + error);
			...
			error = gl.glGetError();
			if (error != GL10.GL_NO_ERROR)
				Log.e("BytehawksTexture", "load Image2D GLError: " + error);
